...
public class LoginController {
	...
	private void login() {
			...
			if(c !=null && c.getPassword().equals(pass)) {
				...
				switch(rol) {
				case ADMIN ->
					stageManager.switchScene("/persona.fxml", "Gestion Personas");
					
				case COORDINADOR ->
					stageManager.switchScene("/espectaculo.fxml","Gestion Espectaculos");
					
				case ARTISTA ->
					stageManager.switchScene("/numero.fxml","Mis Numeros");
				}
